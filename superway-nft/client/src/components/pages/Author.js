...
import { useCreatorNfts } from '../../components/hooks/nfts';
            ...
            <div className='d_profile de-flex'>
              <div className='de-flex-col'>
                <div className='profile_avatar'>
                  <img src='./img/author/author-7.jpg' alt='' />
                  ...
                  <div className='profile_name'>
                    ...
                    <span className='profile_username'>@monicaaa</span> */}
                      <span id='wallet' className='profile_wallet'>
                        {signerAddress || 'Please connect account.'}
                      </span>
                      <button
                        id='btn_copy'
                        title='Copy Text'
      ...
      <section className='container no-top'>
        ...
        {openMenu && (
          <div id='zero1' className='onStep fadeIn'>
            <ColumnZero nfts={onSale || []} status={status} />
          </div>
        )}
        {openMenu1 && (
          <div id='zero2' className='onStep fadeIn'>
            <ColumnZeroTwo nfts={sold} status={status} />
          </div>
        )}
        {openMenu2 && (
